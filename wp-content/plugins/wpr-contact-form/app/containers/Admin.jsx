...
export default class Admin extends Component {
	...
	deleteSetting = () => {
		this.fetchWP
			.delete('admin')
			.then((json) => this.processOkResponse(json, 'deleted'), (err) => console.log('error', err));
	};
		...
		return (
			<div className="wrap">
				...
				<form>
					...
					<label>
						Notification Email:
						<input type="email" value={this.state.email} onChange={this.updateInput} />
					</label>

					<button id="save" className="button button-primary" onClick={this.handleSave}>
						Save
					</button>

					<button id="delete" className="button button-primary" onClick={this.handleDelete}>
						Delete
					</button>
				</form>
			</div>
