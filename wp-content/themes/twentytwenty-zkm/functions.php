...
function customize_social_icons( $icons ) {
    // Define constants for social icons
    define( 'ICON_STACKOVERFLOW', '<svg className="svg-icon" aria-hidden="true" role="img" focusable="false" width="24" height="24" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg"><path d="M189.4,629.2v65.3h315.2v-65.3H189.4z M194.8,511.9l-4.5,65.3
